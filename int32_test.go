...
func TestI32SliceDelete(t *testing.T) {
	...
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), -1, I32List(0, 1, 2, 3, 4, 5))
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), 0, I32List(1, 2, 3, 4, 5))
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), 1, I32List(0, 2, 3, 4, 5))
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), 2, I32List(0, 1, 3, 4, 5))
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), 3, I32List(0, 1, 2, 4, 5))
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), 4, I32List(0, 1, 2, 3, 5))
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), 5, I32List(0, 1, 2, 3, 4))
	ConfirmCut(I32List(0, 1, 2, 3, 4, 5), 6, I32List(0, 1, 2, 3, 4, 5))
}
...
func TestI32SliceSubslice(t *testing.T) {
	ConfirmSubslice := func(s *I32Slice, start, end int, r *I32Slice) {
		if x := s.Subslice(start, end); !r.Equal(x) {
			t.Fatalf("Subslice(%v, %v) should be %v but is %v", start, end, r, x)
		}
	}
	t.Fatal()
	ConfirmSubslice(I32List(), 0, 1, nil)
}
...
func TestI32SliceRplacd(t *testing.T) {
	...
	ConfirmRplacd(I32List(1, 2, 3, 4, 5), I32List(2, 4, 8, 16, 32), I32List(1, 2, 4, 8, 16, 32))
}